    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-12 gap-4 mt-8">
                <div className="xl:col-span-2 lg:col-span-2 md:col-span-2 col-span-5">
                ...
                <div className="xl:col-span-4 lg:col-span-4 md:col-span-4 col-span-7">
            ...
            {/* price & quantity  */}
            {!admin && (
                <div className="border-2 px-3 py-2 rounded-md xl:w-3/4 lg:w-3/4 md:w-3/4 w-full  flex justify-between items-center mt-2">
                    <div>
